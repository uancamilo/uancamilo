 ...
 */
function CodeBlock({ codeBlocksMap, inline, className, children }) {
  ...
  return (
    <pre style={{ backgroundColor: '#24292e', color: '#e1e4e8' }} className="p-4 rounded-lg overflow-x-auto my-6">
      <code className="font-mono text-sm" style={{ color: 'inherit' }}>
        {children}
      </code>
    </pre>
  );

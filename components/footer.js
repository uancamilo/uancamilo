		...
		<footer className="min-h-screen bg-[#F1F5F9] text-[#2F2F2F] flex flex-col">
			...
			<div className="flex-grow flex flex-col justify-center">
				...
				<div className="text-center mb-12 px-6">
					...
					<p className="text-[#4B5563] text-base mt-2 max-w-xl mx-auto">
						Creamos sitios web claros, accesibles y funcionales para ayudarte a
						conectar con tu audiencia desde el primer clic.
					</p>
				</div>

				{/* Grid de contenido */}
				<div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 px-6 sm:px-10 text-sm">
					{/* Enlaces rápidos */}
					<div>
						...
						<ul className="space-y-2">
							<li>
								<a
									...
									className="hover:underline"
								>
									WhatsApp: +57 310 503 8505
								</a>
							</li>
							<li>
								<a
									href="mailto:uancamilo@gmail.com"
									className="hover:underline"
								>
			...
			{/* Créditos al fondo */}
			<div className="text-center mt-12 mb-6 text-[#6B7280] text-sm px-6">
				<p>
					Desarrollado por{" "}
					<span className="font-semibold text-[#2F2F2F]">Lybre</span> con
					tecnologías abiertas y modernas, desde Medellín, Colombia.
				</p>
				<p className="mt-2">
					© {new Date().getFullYear()} Lybre. Todos los derechos reservados.
				</p>
			</div>
		</footer>
	);

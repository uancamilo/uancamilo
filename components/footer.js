		...
		<footer>
					...
					<div className="flex flex-col justify-between">
						<div>
							...
							<ul className="flex justify-around text-center ">
								<li>
									<Link href="/perfil">
										<a className="underline">perfil</a>
									</Link>
								</li>
								<li>proyectos</li>
								<li>historia</li>
								<li>
									<Link href="/contacto">
										<a className="underline">contacto</a>
									</Link>
								</li>
							</ul>
						</div>
			...
			<div className="flex justify-center items-center bg-[#00d4ff] py-10 text-gray-200">
				...
				<p className="text-xl flex items-center">
					2023 uancamilo<span className="text-3xl"> 🦄 </span>
				</p>
			</div>
		</footer>
	);
